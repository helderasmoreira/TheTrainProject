...
RouteStop.create(route_id: r2.id, stop_id: s7.id, stop_order: 1, delay: 100)
RouteStop.create(route_id: r2.id, stop_id: s6.id, stop_order: 2, delay: 80)
RouteStop.create(route_id: r2.id, stop_id: s1.id, stop_order: 3, delay: 60)
RouteStop.create(route_id: r2.id, stop_id: s8.id, stop_order: 4, delay: 25)
RouteStop.create(route_id: r2.id, stop_id: s9.id, stop_order: 5, delay: 0)
